...
<body>
        ...
        <div class="content">
            ...
            <a href="1.php">
                <div class="sneaker">
                    <img alt="New Balance C-ms574" src="./images/10.png" class="sneaker-image" />
            ...
            <a href="2.php">
                <div class="sneaker">
                    <img alt="Nike Dunk Low SP" src="./images/11.png" class="sneaker-image" />
                    <div class="sneaker-info">
            ...
            <a href="3.php">
                <div class="sneaker">
                    <img alt="Converse Chuck 70 High" src="./images/12.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="adidas Yeezy Foam RNNR" src="./images/13.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="Nike Air Max Plus" src="./images/14.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="Jordan 1 Retro High OG SP" src="./images/15.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="adidas Campus 00s" src="./images/16.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="UGG Classic Ultra Mini Boot" src="./images/17.png" class="sneaker-image" />
                    <div class="sneaker-info">
                ...
                <div class="sneaker">
                    <img alt="Jordan 1 Retro Low Golf" src="./images/18.png" class="sneaker-image" />
                    <div class="sneaker-info">
